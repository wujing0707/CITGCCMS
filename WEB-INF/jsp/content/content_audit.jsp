...
function back() {
    window.location.href = "${pageContext.request.contextPath}/content/toContentsApp.action";
}
...
<body class="bodyBG">
    <div class="con" id="con">
       ...
       <div id="tab_zzjs_1">
                <span class="positon">
                    <h3 class="h3Auto"> <a class="tabBbg" href="javascript:void(0);"> <span>内容审核</span> </a> </h3>
                </span>
                <div class="padT23">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table4">
       <tr>
           <th align="right" nowrap="nowrap">栏目：</th>
           <td colspan="3">
           <input class="easyui-combotree" name="parentId" id="parentId" readonly="readonly" size="30" value="${contentChannels}" data-options=" url: ' ${pageContext.request.contextPath}/channel/listChannels.action' " >
...
<%--             <input id="channel" class="easyui-combotree" data-options="width:200,url:'${pageContext.request.contextPath}/channel/listChannels.action'" >&nbsp;（必填） --%>
       ...
       <tr>
           ...
           <td colspan="3"><input name="title" id="title" readonly="readonly" type="text" size="50"  class="easyui-validatebox" validType="null" value="${content.title }" required="required" missingMessage="标题不能为空！" maxlength="40" onblur=""/></td>
       </tr>
      <tr>
           <th align="right">关键字：</th>
           <td colspan="3"><input name="keyWords" id="keyWords" readonly="readonly" maxlength="50" value="${content.keyWords}" class="easyui-validatebox validatebox-text"/></td>
       </tr>
       <tr>
           <th align="right">描述：</th>
           <td colspan="3"><input name="description" id="description" readonly="readonly" maxlength="50" value="${content.description}" class="easyui-validatebox validatebox-text" /></td>
       </tr>
       ...
       <tr>
			        ...
			        <tr>
			            <th>审核备注：</th>
			            <td>
			                <textarea id="summary_approve" rows="3" cols="50"></textarea>
			            </td>
			        </tr>
        <tr id="submit_tr">
                    <th colspan="4">
