...
function seachContent(){
 ...
 function submitForm(companyname,gszch,zzjgdm) {
	 document.getElementById("companyname").value = companyname;
	 document.getElementById("gszch").value = gszch;
	  document.getElementById("template").value = '2';
	 document.getElementById("zzjgdm").value = zzjgdm;
        ...
        <div class="right f_r">
            ...
            <div class="pad30">
                <table class="tablelist table">
	                ...
	                <td>${arr['gszch']}</td>
	                <td>${arr['zzjgdm']}</td>
	                <td><a href="javascript:void(0)" onclick="submitForm('${arr['qymc']}', '${arr['gszch']}', '${arr['zzjgdm']}')"  class="tablelink">查看</a></font></td>
	                </tr> 
                	</c:forEach> 
                    </tbody>
                    <tr><td colspan="4" style="color:red"><div style="text-align: right;">模糊查询最多显示10条匹配记录,当前匹配${size }条记录</div></td></tr>
                    
                    
                </table>
                  <input type="button" class="btn" value="返回" onclick="history.go(-1)" style="float:right" />
                  <form action="../seach/seachdetail.action" id="cform"" method="post">
                    <input type="hidden" name="companyname" id="companyname"/>
                    <input type="hidden" name="gszch" id="gszch"/>
                    <input type="hidden" name="zzjgdm" id="zzjgdm"/>
