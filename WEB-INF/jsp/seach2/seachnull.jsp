    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
        	...
        	<div class="left_link mt10">
                <a href="<%=basePath %>html2/seach.html"><img src="<%=basePath %>html2/images/icon1.png" /><br />信用查询</a>
            </div>
        ...
        <!--right begin-->
        <div class="right f_r">
            <div style="display:none" class="right_tit"><span>当前位置：<a href="#">信用查询</a> > <em>企业信用查询</em></span></div>
            <div class="pad30">
            <p>暂无相关数据</p>
            </div> 
