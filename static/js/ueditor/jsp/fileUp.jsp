    <%@page import="java.io.File"%>
        ...
        <%@ page import="ueditor.Uploader" %>
         <%--@ page import="com.wa.cms.util.Uploader" --%>
    ...
    String[] fileType = {".rar" , ".doc" , ".docx" , ".zip" , ".pdf" , ".txt" , ".swf", ".wmv", ".avi", ".rm", ".rmvb", ".mpeg", ".mpg", ".ogg", ".mov", ".wmv", ".mp4", ".flv",".xls",".xlsx", ".jpg", ".bmp" , ".png"};  //允许的文件类型
