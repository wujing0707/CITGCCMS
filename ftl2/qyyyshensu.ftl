...
<div class="cloud">
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                ...
                <ul>
	                ...
	                <li><a href="#" onClick="reload(3)" target="mainFrame">企业异议申诉</a></li>
        ...
        <!--right begin-->
        <div class="right f_r">
            <div class="right_tit" style="display: none"><span>当前位置： 信用异议申诉 > <em>企业异议申诉</em></span></div>
            <div class="pad10">
                <ul class="forminfo">
               <iframe src="../html2/1.html" name="mainFrame"  height="650" width="100%"></iframe>
                </ul>
            </div> 
