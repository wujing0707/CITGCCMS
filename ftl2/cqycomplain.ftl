...
$(function () {
	...
	$('#ifm').attr("src","http://${ip!}/complain/editComplain.action?UTYPE=C&CHECK=Y&qyZzjgdm="+cookie_val);
});
...
<div class="cloud">
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                ...
                <ul>
	                ...
	                <li><a href="cqycomplain.html" class="current">企业异议申诉</a></li>
        ...
        <div class="right f_r">
            ...
            <div class="pad10">
                <ul class="forminfo">
                <iframe id="ifm" src="http://${ip!}/complain/editComplain.action?UTYPE=C&CHECK=Y" name="mainFrame" scrolling="no" id="win" onload="Javascript:SetWinHeight(this)" frameborder="0" marginheight="0" marginwidth="0" height="900px" width="100%"></iframe>
                </ul>
            </div> 
        </div>
        <!--right over-->
