    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
				...
				<#if (cc.status)??&&cc.status==0>
                <li><a href="content${cc.channelId}_1.html" <#if channel.channelId?? && cc.channelId?? && channel.channelId == cc.channelId>class="current"</#if>>${cc.name!}</a></li>
                </#if>
		    	</#list>
		    	</#if>
                </ul>
        	...
        	<div class="left_link mt10">
                <a href="seach.html" target="_blank"><img src="images/icon1.png" /><em>信用查询</em></a>
            </div>
            
        	<div class="left_link mt10">
                <a href="qycomplain.html" class="bg_co2" target="_blank"><img src="images/icon2.png" /><em>异议申诉</em></a>
            </div>
        ...
        <!--right begin-->
        <div class="right f_r">
            <div class="right_tit"><span>当前位置：<#if preName??&&preName!="顶级栏目">${preName} > </#if><em>${channel.name}</em> </span></div>
            <div class="pad10">
