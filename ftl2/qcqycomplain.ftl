...
$(function () {
	...
	$('#ifm').attr("src","http://${ip!}/complain/editComplain.action?UTYPE=P&CHECK=Y&pNum="+cookie_val);
});
...
<div class="cloud">
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                ...
                <ul>
	                ...
	                <li><a href="qcqycomplain.html" class="current">个人异议申诉</a></li>
                </ul>
            </div>
        ...
        <div class="right f_r">
            ...
            <div class="pad10">
                <ul class="forminfo">
                <iframe id="ifm" src="http://${ip!}/complain/editComplain.action?UTYPE=P&CHECK=Y" name="mainFrame" scrolling="no" id="win" onload="Javascript:SetWinHeight(this)" frameborder="0" marginheight="0" marginwidth="0" height="900px" width="100%"></iframe>
                </ul>
            </div> 
        </div>
        <!--right over-->
