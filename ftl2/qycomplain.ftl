...
$(function () {
	createCode(0);
	createCode(3);
	var cookie_val = getCookie("qyZzjgdm");
	$('#ifm').attr("src","http://${ip!}/complain/queryComplains.action?UTYPE=C&CHECK=Y&qyZzjgdm="+cookie_val);
});
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                <h2>信用异议申诉</h2>
                <ul>
                    <li><a href="qycomplain.html" class="current"><span id='qyss'>企业申诉列表</span></a></li>
        ...
        <!--right begin-->
        <div class="right f_r">
            <div class="right_tit" style="display: none"><span>当前位置：<a href="#" target="_blank">首页</a> > 信用异议申诉 > <em>企业异议申诉</em></span></div>
            <div class="pad10">
                <ul class="forminfo">
                <iframe id="ifm" src="http://${ip!}/complain/queryComplains.action?UTYPE=C&CHECK=Y" name="mainFrame" scrolling="no" id="win" onload="Javascript:SetWinHeight(this)" frameborder="0" marginheight="0" marginwidth="0" height="400px" width="100%"></iframe>
                </ul>
            </div> 
        </div>
        <!--right over-->
