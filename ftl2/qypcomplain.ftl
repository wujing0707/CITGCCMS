...
$(function () {
	...
	$('#ifm').attr("src","http://${ip!}/complain/queryComplains.action?UTYPE=P&CHECK=Y&pNum="+cookie_val);
});
...
<div class="cloud">
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                ...
                <ul>
	                ...
	                <li><a href="qypcomplain.html" class="current"><span id='grss'>个人申诉列表</span></a></li>
        ...
        <div class="right f_r">
            ...
            <div class="pad10">
                <ul class="forminfo">
                <iframe id="ifm" src="http://${ip!}/complain/queryComplains.action?UTYPE=P&CHECK=Y" name="mainFrame" scrolling="no" id="win" onload="Javascript:SetWinHeight(this)" frameborder="0" marginheight="0" marginwidth="0" height="400px" width="100%"></iframe>
                </ul>
            </div> 
        </div>
        <!--right over-->
