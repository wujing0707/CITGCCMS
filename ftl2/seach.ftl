    ...
    //   var checkCode = document.getElementById("checkCodeID"+i).value;  
      ...
      // } else 
       if(zzjgdm==""&&gszch==""&&companyname==""){
               ...
               var url = "../seach/checkSeachdetail.action?date="+new Date().getTime();
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                <h2>信用查询</h2>
                <ul>
                    <li><a href="seach.html" class="current">法人信用查询</a></li>
        ...
        <!--right begin-->
        <div class="right f_r">
            <div style="display:none" class=" tit1 right_tit"><span>当前位置：<a href="#">信用查询</a> > <em>企业信用查询</em></span></div>
            <div class="pad10 pad_t50">
                  <form action="../seach/searchDetailList.action" method="post" id="seaForm">
                   <input name="template" type="hidden" value="2"/>
                  <ul class="forminfo">
                    <li>
                      <label>企业名称</label>
                      <input id="companyname" name="companyname" type="text" class="dfinput" />
                    </li>
                    <li>
                      <label>工商注册号</label>
                      <input id="gszch" name="gszch" type="text" class="dfinput" />
                    </li>
                    <li>
                      <label>组织机构代码</label>
                      <input id="zzjgdm" name="zzjgdm" type="text" class="dfinput" value="" />
                    </li>
                    <li>
                      <label>验证码</label>
