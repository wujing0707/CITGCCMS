...
<div class="cloud">
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                ...
                <ul>
                    ...
                    <li><a href="xyhcm.html" class="current">查询码核查</a></li>
        ...
        <!--right begin-->
        <div class="right f_r">
            <div style="display: none" class=" tit1 right_tit"><span>当前位置： <a href="#">信用查询</a> > <em>信用核查码</em></span></div>
            <div class="pad10" style="padding-top:100px;">
                  <ul class="forminfo">
                  <form action="../seach/checkDetail.action">
                    <li>
                      <label>信用查询码</label>
                      <input id="checkNumber" name="checknumber" type="text" class="dfinput" />
                    </li>
                    <li>
                      <label>&nbsp;</label>
                      <input name="" type="button" class="btn" onClick="query()" value="查 询"/>
                      <input name="" type="reset" class="btn" value="重 置"/>
                    </li>
                    </form>
                  </ul>
            </div> 
