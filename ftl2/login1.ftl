    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                <h2>信用异议申诉</h2>
                <ul>
                    <li><a href="qycomplain.html"><span id='qyss'>企业申诉列表</span></a></li>
	                <li><a href="qypcomplain.html"><span id='grss'>个人申诉列表</span></a></li>
	                <li><a href="cqycomplain.html">企业异议申诉</a></li>
	                <li><a href="qcqycomplain.html">个人异议申诉</a></li>
                </ul>
            </div>
        ...
        <p>请先登录再进行申诉！</p>
          <table width="400px">
			    <tbody><tr>
			      ...
			      <td align="left"><input type="text" class="dfinput w200" onblur="checkUsername();" /></td>
			    </tr>
			    <tr>
			      <td style="width:80px;height:50px">密码:</td>
			      <td align="left"><input type="password" onblur="checkPassword();" class="dfinput w200" /></td>
			    </tr>
			     <tr>
			      <td style="width:80px;height:50px">验证码:</td>
			      <td align="left"><input type="text" style="border: 1px solid #a7b5bc;height: 30px;line-height: 30px;text-indent: 5px;width: 80px;" value=""  size="3" class="" maxlength="5" /><img style="cursor: pointer;vertical-align:middle;height:35px" src="../CodeServlet.code" onclick="this.src='../CodeServlet.code?'+new Date().getTime();" /></td>
			    </tr>
			    <tr>
			      <td align="center" colspan="2" style="color:red">*注:请输入验证码计算结果数字，如出现负数请输入负数</td>
			    </tr>
			       <tr>
			      <td align="center" colspan="2"><input type="button" value="登录" class="sure"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" onclick="registion();" value="注册" class="sure" />&nbsp;</td>
			    </tr>
			  </tbody>
			 </table>
    </div>
    ...
    <div class="tipnr tc">
        ...
        <div id="error" class="prompt1" style="color:red;"></div>
          <table width="400px">
			    ...
			    <tr>
			      <td style="width:80px;height:50px">组织机构代码:</td>
			      <td align="left"><input type="text" id="loginZzjgdm" name="loginZzjgdm" onblur="checkLoginInput();" class="dfinput w200" /></td>
			    </tr>
			    <tr>
			      <td style="width:80px;height:50px">密码:</td>
...
$(document).ready(function(){
  ...
  $('#btnLogin').click(function(){
   var inputCode = document.getElementById("srand").value;
	...
	$.post("../frontLogin.action", {username: $("#username").val(), loginZzjgdm: $("#loginZzjgdm").val(), password: $("#password").val(), srand: $("#srand").val()},
		function(data) {
			if (data.result == true) {
...
function checkLoginInput() {
	var loginZzjgdm = $("#loginZzjgdm").val();
	if ($.trim(loginZzjgdm) == "") {
		$("#error").html("组织机构代码不能为空!");
		return false;
	} else {
		$("#error").html("");
		return true;
