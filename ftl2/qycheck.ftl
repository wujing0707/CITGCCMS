...
$(function () {
	...
	$('#ifm').attr("src","http://${ip!}/creditVerification/tocreditVerification.action?UTYPE=C&CHECK=Y&qyZzjgdm="+cookie_val);  
});
...
<div class="cloud">
    ...
    <div class="wrap mt10">
        ...
        <div class="leftbox f_l">
            <div class="left_menu">
                ...
                <ul>
                    ...
                    <li><a href="#" onClick="reload(1)" target="mainFrame" class="current">法人信用核查</a></li>
        ...
        <!--right begin-->
        <div class="right f_r">
            <iframe id="ifm" src="http://${ip!}/creditVerification/tocreditVerification.action?UTYPE=C&CHECK=Y" name="mainFrame" frameborder="0" scrolling="no" id="win" onload="Javascript:SetWinHeight(this)" marginheight="0" marginwidth="0" height="470" width="100%"></iframe>
        </div>
        <!--right over-->
    </div>
    <!--center over-->
